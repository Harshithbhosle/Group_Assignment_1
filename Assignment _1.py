...
def calculate_relative_miss(x, y, n):
    ...
    if miss_lower < miss_upper:
        closest_z = z_lower
        relative_size = z_lower / xn_yn
    else:
        closest_z = z_upper
        relative_size = z_upper / xn_yn
        
    return closest_z, miss_upper if miss_upper < miss_lower else miss_lower, relative_size
...
def find_near_misses(n, k):
    ...
    print(f"smallest_miss: {smallest_miss}")
    print(f"smallest_relative_size: {smallest_relative_size}")
